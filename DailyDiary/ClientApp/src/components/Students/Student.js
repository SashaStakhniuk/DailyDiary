    ...
    return(
        ...
        <div className="wraper">
            ...
            <section className="page__section page__section_1">
                <h1 className="page__title">Main</h1>
            ...
            <section className="page__section page__section_3">
                <h2 className="page__sub-title">Hw</h2>
                <div className="page__text">
            ...
            <section className="page__section page__section_4">
                <h2 className="page__sub-title">Profil</h2>
                <div className="page__text">
