...
//                    var studyPlanSubjectsCollection = await db.StudyPlans.Where(x=> x.YearOfStudyId==group.YearOfStudyId).Select(x=> x.SubjectsHoursCollection).FirstOrDefaultAsync();
